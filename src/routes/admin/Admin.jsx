...
export default function Admin() {
  ...
  return (
    <>
      ...
      <div className="outerlayout flex flex-row w-full text-center mt-1">
        {/* Sidebar */}
        <div className="w-[50px] bg-base-100 flex flex-col gap-2 sm:flex-col">
          <div className="lg:tooltip lg:tooltip-right" data-tip="Profile">
            <button onClick={() => setCurrentPage("profile")} className="btn btn-primary w-full ml-1" > <CgProfile className="w-7 h-7" /> </button>
          </div>
