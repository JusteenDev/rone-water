                ...
                <div className="modal-box flex flex-col items-center justify-center">
                  <div className="flex flex-col items-start justify-center w-full">
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <button className="btn btn-sm btn-primary" onClick={incrementQuantity}>
                        +
                      </button>
                    </div>
                    ...
                    <input
                      type="text"
                      className="input input-md mb-1 w-full bg-base-200"
                      placeholder="Name"
                      value={name}
                  ...
                  <div className="modal-action flex gap-2">
                    <form method="dialog">
                      <a
                        href="tel:0928-433-4978"
                        className="btn btn-md btn-primay bg-primary text-white w-24"
                      >
                        Call us
                      </a>
                    </form>
                    ...
                    <form method="dialog">
                      <button className="btn btn-md btn-primay bg-primary text-white w-24">
                        Cancel
                      </button>
                    </form>
                  </div>
